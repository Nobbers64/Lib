...
local library = {
	...
	colors = {
		main = Color3.fromRGB(66, 134, 245), -- Blue accent
		background = Color3.fromRGB(18, 18, 18), -- Very dark gray (#121212)
		outerBorder = Color3.fromRGB(60, 60, 60), -- Dark gray borders
		innerBorder = Color3.fromRGB(45, 45, 45), -- Slightly darker gray borders
		topGradient = Color3.fromRGB(30, 30, 30), -- Darker gray (#1E1E1E)
		bottomGradient = Color3.fromRGB(24, 24, 24), -- Mid-dark gray
		sectionBackground = Color3.fromRGB(28, 28, 28), -- Slightly lighter than background
		section = Color3.fromRGB(200, 200, 200), -- Light gray for section text
		otherElementText = Color3.fromRGB(185, 185, 185), -- Light gray text
		elementText = Color3.fromRGB(240, 240, 240), -- White text
		elementBorder = Color3.fromRGB(75, 75, 75), -- Border for elements
		selectedOption = Color3.fromRGB(66, 134, 245), -- Blue for selected options
		unselectedOption = Color3.fromRGB(40, 40, 40), -- Dark gray for unselected
		hoveredOptionTop = Color3.fromRGB(65, 65, 65), -- Slightly lighter when hovered
		unhoveredOptionTop = Color3.fromRGB(50, 50, 50), -- Normal state
		hoveredOptionBottom = Color3.fromRGB(55, 55, 55),
		unhoveredOptionBottom = Color3.fromRGB(45, 45, 45),
		tabText = Color3.fromRGB(240, 240, 240) -- White text
	},
	gui_parent = (function()
...
function library:CreateWindow(options, ...)
	...
	if windowName and #windowName > 0 and library.WorkspaceName == "nobgg Lib" then
		library.WorkspaceName = convertfilename(windowName, "nobgg Lib")
	end
